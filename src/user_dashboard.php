...
<div class="even-container">
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                 <h3>our services</h3>
                 <a href="html/services.html?service=dentalcare"> <i class="fas fa-chevron-right"></i> dental care </a>
                 <a href="html/services.html?service=massagetherapy"> <i class="fas fa-chevron-right"></i> massage therapy </a>
                 <a href="html/services.html?service=cardiology"> <i class="fas fa-chevron-right"></i> cardiology </a>
                 <a href="html/services.html?service=diagnosis"> <i class="fas fa-chevron-right"></i> diagnosis </a>
                 <a href="html/services.html?service=ambulance"> <i class="fas fa-chevron-right"></i> ambulance service </a>
           </div>
